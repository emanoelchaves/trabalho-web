...
public class UserService {
	...
	public User addUser(@FormDataParam("image") InputStream uploadedInputStream,
			@FormDataParam("username") String username, @FormDataParam("password") String password, @FormDataParam("name") String name) {

		return UserDAO.addUser(username, password, name , uploadedInputStream);
	}
	...
	public User updateUser(@PathParam("id") int id, @FormDataParam("image") InputStream uploadedInputStream,
		...
		if(contentDispositionHeader.getFileName() == null) {
			return UserDAO.updateUser(id, username, password, name, null);	
		} else {
			return UserDAO.updateUser(id, username, password,name, uploadedInputStream);
		}
	}
